        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label>Email: <strong style="color: green;">(Used in login, please remember after changed.)</strong></label>
                        <input type="text" id="edit_email" alt="edit_email" class="form-control" />
                    </div>
                    <div class="form-group">
                        <label>Password:</label>
                        <input type="text" id="edit_password" class="form-control" minlength="6" maxlength="15" placeholder="atleast 6 digit" />
                    </div>
                    <div class="form-group">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        btn.addEventListener('click', () => {
            ...
            $.ajax({
                url: '../../init/controllers/edit_profileadmin.php',
                type: "POST",
                data: data,
                processData: false,
                contentType: false,
