<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $expires = date("U") + 1800;
         ...
         $sql = "SELECT email FROM `tbl_admin` WHERE `email` = ?";
    ...
    if ($userEmail < 1) {
        echo "No account associated with given Email. Redirecting....";
        header('Refresh: 3; URL= forgot_pass');
        exit();
    }
    ...
    if (!$mail->send()) {
        ...
        echo 'Message sent!';
        header("Location:forgot_pass?reset=success");
    }
        }
    else{
