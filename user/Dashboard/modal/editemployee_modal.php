    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" autocomplete="off">
          ...
          <div class="form-group">
            <label>Password: <strong style="color: green;">(Used in login, please remember after changed.)</strong></label>
          ...
          <div class="form-group">
            ...
            <input type="date" id="edit_datehire" alt="datehire" class="form-control" readonly />
          </div>

          <div class="form-group">
            <label>Designation:</label>
            <input type="text" id="edit_designation" alt="designation" class="form-control" readonly />
          </div>
      </div>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    let btn = document.querySelector('#update-profile');
    btn.addEventListener('click', () => {
      ...
      $.ajax({
        url: '../../init/controllers/edit_profile.php',
        type: "POST",
        data: data,
        processData: false,
        contentType: false,
